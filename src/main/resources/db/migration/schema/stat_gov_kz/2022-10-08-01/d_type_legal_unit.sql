...
values  (742679, 'Заңды тұлға', 'Юридическое лицо', false),
		...
		(742687, 'Бірлескен кәсіпкерлік түріндегі дара кәсіпкерлік субъектісі', 'Субъект индивидуального предпринимательства в виде совместного предпринимательства', false);