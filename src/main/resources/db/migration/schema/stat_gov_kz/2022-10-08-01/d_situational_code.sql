...
values  (39354, 'Қайта тіркелген', 'Вновь зарегистрированное', true),
		(39355, 'Белсенді', 'Активное', true),
		(39356, 'Қызметін уақытша  тоқтатқандар', 'Временно приостановившее деятельность', true),
		(39358, 'Ақпарат жоқ немесе әрекетсіз', 'Нет информации или бездействующий', true),
		(534829, 'Қызметін тоқтатқандар', 'Приостановившее деятельность', true),
		(39359, 'Таратылу үдерісінде', 'В процессе ликвидации', true);
