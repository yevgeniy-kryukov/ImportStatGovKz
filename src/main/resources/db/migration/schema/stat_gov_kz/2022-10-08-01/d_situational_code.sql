...
insert into stat_gov_kz.d_situational_code (id, name_kz, name_ru, is_updated)
values  (39354, 'Қайта тіркелген', 'Вновь зарегистрированное', false),
		(39355, 'Белсенді', 'Активное', true),
		(39356, 'Қызметін уақытша  тоқтатқандар', 'Временно приостановившее деятельность', false),
		(39358, 'Ақпарат жоқ немесе әрекетсіз', 'Нет информации или бездействующий', false),
		(534829, 'Қызметін тоқтатқандар', 'Приостановившее деятельность', false),
		(39359, 'Таратылу үдерісінде', 'В процессе ликвидации', false);
